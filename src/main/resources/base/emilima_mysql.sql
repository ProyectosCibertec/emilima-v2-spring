...
-- Schema emilima
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `emilima` DEFAULT CHARACTER SET utf8mb3 ;
USE `emilima` ;
...
CREATE TABLE IF NOT EXISTS `emilima`.`user_position` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE,
  INDEX `fk_user_position_organic_unit_idx` (`organic_unit_id` ASC) VISIBLE,
  INDEX `fk_user_position_hierarchical_dependency_idx` (`hierarchical_dependency_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `emilima`.`user` (
  ...
  INDEX `fk_user_user_position_idx` (`position_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `emilima`.`documental_serie` (
  ...
  PRIMARY KEY (`code`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE,
  INDEX `fk_documental_serie_hierarchical_dependency_idx` (`hierarchical_dependency_id` ASC) VISIBLE,
  INDEX `fk_documental_serie_organic_unit_idx` (`organic_unit_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `emilima`.`document` (
  ...
  `document_serie_id` CHAR(6) NOT NULL,
  `document_request_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`serial_number`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE,
  INDEX `fk_documentation_file1_idx` (`file_id` ASC) VISIBLE,
  INDEX `fk_documentation_documentation_type_idx` (`document_type_id` ASC) VISIBLE,
  INDEX `fk_documentation_documental_serie_idx` (`document_serie_id` ASC) VISIBLE,
  INDEX `fk_documentation_document_request_idx` (`document_request_id` ASC) VISIBLE,
  CONSTRAINT `fk_document_document_request`
  ...
  CONSTRAINT `fk_document_document_type`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_document_documental_serie`
    FOREIGN KEY (`document_serie_id`)
